...
public enum ResultCode {
	...
	ACCOUNT_PROHIBIT(20004, "Account has been disabled"),  
	ACCOUNT_NOTEXIST(20005, "User doesn't exist"),  
	COUNTRYCODE_NULL(20006, "Country code doesn't exist"),  
	...
	PASSWORD_ATYPISM(20015, "Inconsistent password"),  
	VERIFICATIONCODE(20016, "验证码不正确"),
	VERIFICATIONCODE_OVERDUE(20017, "验证码已过期"),
	PHONE_EXIST(20018, "The phone number already exists"),  
	EMAIL_EXIST(20019, "The email address already exists"),  
	PHONE_UP_FAIL(20020, "User failed to upload image"), 
	OLDPASSWORD_ERR(20021, "Old password is incorrect. Try again"),  
	NEWPASSWORD_CONFIRMPASSWORD_ATYPISM(20022, "New password and the confirmed password do not match"),  
	UPDATEPASSWORD_FAIL(20023, "Failed to modify password"),  
	REGISTER_FAIL(20024, "Failed to sign up"),  
	PHONE_AND_MACADDRESS_MEANWHILENULL(20025, "Phone number and MAC address do not exist"),  
	USERID_NULL(20026, "用户ID不存在"),
	NEWPASSWORD_NULL(20027, "New password doesn't exist"),  
	PHONE_AND_MACADDRESS_MEANWHILEEXIST(20028, "Phone number and MAC address do exist"),  
	MACADDRESS_EXIST(20029, "MAC address already exists"),  
	APPTYPEID_NULL(20030, "Project type doesn't exist"),  
	REGISTERPHONEANDSENDPHONE_DIFF(20031, "注册的电话号码与接收短信的电话号码不匹配。"),
	FEEDBACK_FAIL(20032, "Feedback failed."),  
	PHONEMODEL_NULL(20033, "Mobile phone model doesn’t exist."),  
	USER_LOGGED_IN(20034, "User is logged in."),
	LOGSTATUS_NULL(20035, "Login status doesn’t exist."),  
	LOGHISTORY_FAIL(20036, "Failed to record mobile phone login history."),  
	SNNUM_NULL(20037, "SN number is empty."),  
	SECONDVALI_FAIL(20038, "Verification failed."),
	PUSHTOKEN_NULL(20039, "Offline token doesn’t exist."),
	...
	COUNTRYLIST_ERR(30002, "Country list request failed"),  
	CITYLIST_ERR(30003, "City list request failed"),  
	LOCATION_FAIL(30004, "Failed to find current location"),  
	BINDING_ERR(30005, "Failed to bind device"),  
	UNBINDING_ERR(30006, "Failed to unbind device"), 
	SEEINFO_FAIL(30007, "Failed to view information"),  
	UPDATEINFO_FAIL(30008, "Failed to modify information"),  
	EQUIPMENT_LIST_FAIL(30009, "Failed to get device list"),
	...
	UNBLOCK_NULL(30037, "Blacklist status doesn't exist"),
	DONOTDISTURB_NULL(30038, "Whitelist status doesn't exist"),
	...
	EQUI_NO_BINDING(30044, "Device is not bound."),
	EQUIUPDATE_FAIL(30045, "Failed to update Tablet status."),
	EQUISTATUS_NULL(30046, "Tablet status doesn’t exist."),
	DEVICELOCKUPDATE_FAIL(30047, "Failed to modify device lock."),
	DELHISTORY_FAIL(30048, "Failed to delete history."),
	 ...
	 * IM服务:40001-49999
	 */
	IM_REGISTER_FAIL(40001, "IM registration failed"),
	IM_UPDATEPWD_FAIL(40002, "Failed to modify IM"),
	IM_UPDATEINFO_FAIL(40003, "Failed to modify IM information"),
	
	/*
	 * 文件异常：50001-59999
	 */
	UPLOAD_NULL(50001, "The uploaded file doesn't exist"),
	UPLOAD_FILE_FAIL(50002, "Failed to upload file"),  
	DELETE_FAIL(50003, "Failed to delete"),  
	FILE_NOEXIST(50004, "File doesn't exist"),  
	
	
	/*
	 * 区域码：60001-69999
	 */
	PARENTID_NULL(60001, "Parent ID doesn't exist"),
	REGIONID_NULL(60002, "Area ID doesn't exist"),
	SETREGIONCODE_FAIL(60003, "Failed to set area code"),
	REGIONCODE_NULL(60004, "Area code doesn't exist"),
	
	/*
	 * 通话记录：70001-79999
	 */
	ADD_CALLACCOUNT_FAIL(70001, "Failed to store call log"),
	CALLACCOUNT_NULL(70002, "Call log doesn't exist"),
	CALLFROM_NULL(70003, "Device number doesn't exist"),
	CALLTYPE_NULL(70004, "Call type doesn't exist"),
	STARTTIME_NULL(70005, "Star time doesn't exist"),
	ENDTIME_NULL(70006, "End time doesn't exist"),

	/*
	 * 	使用指南：80001-89999
	 */
	LANGUAGETYPE_NULL(80001, "Language doesn't exist"),
	SELECTUSERMANUAL_FAIL(80002, "Failed to get user manual"),
	

	/*
	 * 	APP：90001-99999
	 */
	APPVERSION_NULL(90001, "Version number doesn't exist"),
	APPPCGNAME_NOEXIST(90002, "APP包名不存在"),
