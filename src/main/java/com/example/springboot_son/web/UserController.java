...
public class UserController {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "user_name", value = "手机号", dataType = "String", paramType = "query"),
            @ApiImplicitParam(name = "phone_model", value = "手机型号", dataType = "int", paramType = "query"),
    ...
    public ResponseResult userPhoneRegister(String user_name,  String phone_model,
        ...
        if (UserController.date == null) {
            ...
            if (null== UserController.oldPhone || !(UserController.oldPhone).equals(user_name)) {
